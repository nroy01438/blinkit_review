      ...
      <header>
        <p className="mb-1 text-xs font-medium uppercase tracking-wide text-slate-400">
          <Link href="/" className="hover:text-slate-600">
            ← Back to Discovery Insights
          </Link>
        </p>
        <h1 className="text-2xl font-bold text-slate-900">Pipeline &amp; methodology</h1>
        <p className="mt-1 text-sm text-slate-600">
          How the corpus was filtered and how much to trust the classifier — the engineering detail behind the
          numbers on the home page. Every number below ships with n, a denominator, and a 95% CI.
        </p>
      </header>
